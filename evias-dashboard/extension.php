...
return [
	...
	*/
	...
	'description' => 'Extension adding Admin/Frontend Dashboard modules',
	...
	*/
	...
	{
        Route::get(admin_uri(), 'eVias\Dashboard\Controllers\Admin\DashboardController@index');
        Route::get(admin_uri() . "/getInteractiveLabelWidget", [
					'as'	=> 'evias.widgets.getInteractiveLabelWidget',
					'uses'	=> 'eVias\Dashboard\Controllers\Admin\DashboardController@getInteractiveLabelWidget']);

        // frontend routes
        Route::group(['namespace' => 'eVias\Dashboard\Controllers\Frontend',], function()
		{
			Route::get('dashboard', ['as' => 'liberty.dashboard.home', 'uses' => 'DashboardsController@index']);
			Route::get('products', ['as' => 'liberty.dashboard.products', 'uses' => 'DashboardsController@products']);
		});
	},
	...
	*/
	...
	'permissions' => function(Permissions $permissions)
	{
		$permissions->group('dashboard', function ($g) {
            $g->name = trans('platform/dashboard::common.title');

            $g->permission('admin.dashboard', function ($p) {
                $p->label = trans('platform/dashboard::permissions.dashboard');

                $p->controller('eVias\Dashboard\Controllers\Admin\DashboardController', 'index');
            });
        });
	},
	...
	*/
	...
	'menus' => [
		...
		'admin' => [
			...
			[
				'slug'  => 'admin-evias-dashboard',
				'name'  => 'Dashboard',
				'class' => 'fa fa-circle-o',
				'uri'   => 'dashboard',
				'regex' => '/:admin\/dashboard/i',
			],
